...
import picture1 from '../../img/index2.jpg';
import picture2 from '../../img/gallery12.jpg';
import picture3 from '../../img/gallery13.jpg';
    ...
    <div id='salesContainer'>
        <div className='pitch'>
            <div className='pitchBorder'>
                <img src={picture1} alt={'A lovely bathroom'}/>
        ...
        <div className='pitch'>
            <div className='pitchBorder'>
                ...
                <img src={picture2} alt={'A lovely bathroom'}/>
            </div>
        </div>
        <div className='pitch'>
            <div className='pitchBorder'>
                <img src={picture3} alt={'A lovely bathroom'}/>
                <div className='pitchText'>  
